...
def seed_products():
    ...
    product_4 = Product('Firebird V Tom Murphy', 2500.99, 3)
    product_5 = Product('Godin Guitars 5th Avenue', 681.99, 5)
    product_6 = Product('Gibson Les Paul Money Bass', 1049.99, 0)
    product_7 = Product('Boulder Creek Left Handed EBR3-N4L 4 String', 999.99, 2)
